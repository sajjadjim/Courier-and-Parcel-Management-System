            ...
            <div className="bg-gradient-to-br from-[#022c31] to-[#044e54] rounded-[2.5rem] overflow-hidden relative shadow-2xl">
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between p-8 md:p-20 gap-12 relative z-10">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left space-y-8">
                        ...
                        >
                            <button className="px-8 py-4 bg-[#CAEB66] text-[#022c31] text-lg font-bold rounded-full shadow-[0_0_20px_rgba(202,235,102,0.3)] hover:shadow-[0_0_30px_rgba(202,235,102,0.5)] hover:bg-white transition-all flex items-center justify-center gap-2 active:scale-95">
                                Become a Merchant <FaArrowRight />
                            </button>
                            <button className="px-8 py-4 bg-transparent border border-white/30 text-white text-lg font-bold rounded-full hover:bg-white/10 hover:border-white transition-all flex items-center justify-center gap-2 active:scale-95">
